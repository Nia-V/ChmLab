...
\section*{Conclusion}
\paragraph{}Notre recommandation à La Broue est la suivante : l'implantation de la brasserie à Loublonnière est possible, mais l'utilisation d'un filtre industriel à billes de résine échangeuse d'ions 2Na+ est recommandée pour fixer les ions Ca2+ et adoucir l'eau. En effet, le traitement proposé ne serait pas simple pour une production industrielle, que ce soit par lots ou en continu \parencite{purolite_industrial_nodate}. \\
