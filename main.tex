...
\section*{Conclusion}
\paragraph{}Notre recommandation à La Broue est la suivante : l'implantation de la brasserie à Loublonnière est possible, mais l'utilisation d'un filtre industriel à billes de résine échangeuse d'ions 2Na+ est recommandée pour fixer les ions Ca2+ et adoucir l'eau. En effet, le traitement proposé ne serait ni simple ni pratique pour une production industrielle, que ce soit par lots ou en continu \parencite{purolite_industrial_nodate}. \\

L'utilisation du gel polystyrénique, billes de résine cationique à acide fort (forme sodium), présente l'avantage d'avoir une capacité opérationnelle beaucoup plus élevée ; cependant, un inconvénient est qu'il finira par s'épuiser et devra être rechargé, et cet entretien pourrait éventuellement entraver le processus\parencite{purolite_purolite_nodate}.
...
\clearpage
\section*{Annexe}
\paragraph{}Notre incertitude instrumentale a été déterminée en fonction des appareils utilisés pour effectuer les mesures. Pour les mesures de masse réalisées avec l’aide de la balance numérique, nous avons choisi l’incertitude égale à la moitié de la plus petite division. Pour les volumes, on a dû utiliser les graduations sur les instruments (erlenmeyer, bécher, burette).\\\\
L'incertitude expérimentale a été prise en fonction de notre jugement et de plusieurs essais. Des variations ont pu être observées dans le volume du filtrat, dans la masse du précipité ou encore dans la perception de la couleur plus ou moins claire lors du titrage.
