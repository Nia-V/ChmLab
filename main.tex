...
\subsection*{Calculs}
\begin{enumerate}
    \item $(7,7\pm 0,2)\times 10^{-3}\mathrm{mL}$
...
\paragraph{}Notre pourcentage de récupération est de \(98\%\) ce qui indique que notre réaction a pu faire précipiter presque tout le calcium présent dans l’échantillon. Voici deux hypothèses qui expliquent notre recouvrement inférieur à \(100\%\) causée par certaines pertes et des limites de précision:
\subsubsection*{Gouttes d’eau résiduelles}
\subparagraph{}Lors des différents transvasements (bécher à erlenmeyer, cylindre gradué à bécher) une petite quantité de solution reste toujours collée aux parois. Cette perte diminue donc légèrement la quantité de \(Ca^{2+}\) réellement précipitée ou titrée avec l’EDTA. Ces pertes sont de quelques gouttes et elles pourraient correspondre à notre écart de 2\% avec le \(100\%\) de recouvrement attendu. Une meilleure technique de manipulation pourrait permettre de réduire cette différence.\\

\subsubsection*{Détermination du point de virage lors du titrage à l’EDTA}

\subparagraph{}Le changement de couleur du violet au bleu peut être dur à identifier. L’éclairage, la perception de la couleur et la vitesse d’ajout de l’EDTA ont influencé le volume mesuré. Notre incertitude instrumentale de 0,05 mL (environ une goutte) expliquerait l’écart de \(2\%\) dans le recouvrement.
\clearpage
