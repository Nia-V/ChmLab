...
\subsection*{Calculs}
\begin{enumerate}
    \item $(7,7\pm 0,2)\,\mathrm{mL}$\\ Les mesures étant compatibles, nous prenons le point médian. 
...
L’outil ChatGPT a été utilisé pour la re-formulation de certaines sections du texte, conformément aux directives d’utilisation éthique de l’IA de l’ÉTS.
